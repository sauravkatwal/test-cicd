...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`CREATE OR REPLACE FUNCTION "public"."get_whatsapp_engagement_report_list"("campaignid" int4, "tracking_type" varchar, "from_date" date, "to_date" date, "search_query" TEXT)
  ...
  async down(queryInterface, Sequelize) {
    ...
    DROP FUNCTION IF EXISTS get_whatsapp_engagement_report_list();
    `)
  }
};
