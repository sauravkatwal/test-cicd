...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.query(`CREATE OR REPLACE FUNCTION "public"."get_viber_engagement_report_count"("campaign_id" int4, "from_date" date, "to_date" date)
  ...
  async down(queryInterface, Sequelize) {
    ...
    DROP FUNCTION IF EXISTS get_viber_engagement_report_count();
    `)
  }
};
