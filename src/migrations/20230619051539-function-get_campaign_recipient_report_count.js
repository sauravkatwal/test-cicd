...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    RETURNS TABLE("key" varchar, "value" int8) AS $BODY$
      ...
      WHERE b.aws_ses_message_id is null AND mp.slug = messaging_platform AND b.campaign_id = campaignid AND b.created_at::DATE BETWEEN from_date AND to_date and b.deleted_at is null
      UNION ALL
